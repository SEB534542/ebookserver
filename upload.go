...
// allowedFtypes contains the filetypes allowed.
...
func uploadHandler(w http.ResponseWriter, r *http.Request) {
	...
	for _, fileHeader := range files {
		if fileHeader.Size > MAX_UPLOAD_SIZE {
			http.Error(w, fmt.Sprintf("The uploaded file is too big: %s. Please use a file less than %sMB in size", fileHeader.Filename, MAX_UPLOAD_SIZE/1024/1024), http.StatusBadRequest)
			return
		}
